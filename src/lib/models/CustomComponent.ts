...
const CustomComponentSchema = new Schema(
  {
    ...
    // Optional documentation generated by the AI describing how to
    // use the component: summary, fields explanation and examples.
    docs: { type: Schema.Types.Mixed, default: null },
    // Non-destructive history of previous versions; used so AI
    // modifications never destroy earlier work.
    history: [
      new Schema(
        {
          code: { type: String, default: "" },
    ...
    // When true the component was generated via the AI SDK.  This flag
    // allows the editor to distinguish between AI‑generated and
    // manually authored components.  It defaults to false for legacy
